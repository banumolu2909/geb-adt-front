  ...
  useEffect(() => {
    ...
    let shipping_date  = `${shipping_year}-${shipping_month}-${shipping_day}`;
     ...
     //let shipping_date = searchResult[0].shipping_date;
      ...
      //let shipping_date  = new Date(searchResult[0].shipping_date); 
...
<div className={styles.order_form}>  
        <h2>View Order</h2> < br/> <br/> 
        <div className={styles.create_form}>
            <div className={styles.create}>
                <div className={styles.form1}>
                <form >
                    <lable for='date'>Order Date :</lable>
                    <input type="date" onChange={handleChange} name = "order_date" value={order.order_date} readOnly/>  < br/> <br/> 
                    ...
                    <input type="date" onChange={handleChange} readOnly name = "shipping_date" value={order.shipping_date}/>  < br/> <br/>                         
                    <lable for='shippingClass'>Shipping Class   :</lable>
                    <select id="shippingClass" onChange={handleChange} name = "shipping_class" value = {order.shipping_class} readOnly >
                    ...
                    <select id="productCategory" onChange={handleChange} name = "category" readOnly value = {order.category} >
                        <option value="0"></option>
